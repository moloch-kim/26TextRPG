...
namespace _26TextRPG
{
    internal class EnemyRepository
    {
        ...
        static EnemyRepository()
        {
            ...
            {
                new Enemy("들개", 1, 30, 5, 8, 7, 0),
                new Enemy("시궁쥐", 1, 10, 3, 12, 3, 0),
                new Enemy("뿔토끼", 1, 20, 7, 15, 6, 0),
            };
            floor2List = new List<Enemy>() 
            {
                new Enemy("들개2", 1, 30, 5, 8, 7, 0),
            };
            floor3List = new List<Enemy>() 
            {
                new Enemy("들개3", 1, 30, 5, 8, 7, 0),
            };
            floor4List = new List<Enemy>()
            {
                new Enemy("들개4", 1, 30, 5, 8, 7, 0),
            };
            floor5List = new List<Enemy>()
            {
                new Enemy("들개5", 1, 30, 5, 8, 7, 0),
            };
            floor6List = new List<Enemy>()
            {
                new Enemy("들개6", 1, 30, 5, 8, 7, 0),
            };
            floor7List = new List<Enemy>()
            {
                new Enemy("들개7", 1, 30, 5, 8, 7, 0),
            };
            floor8List = new List<Enemy>()
            {
                new Enemy("들개8", 1, 30, 5, 8, 7, 0),
            };
            floor9List = new List<Enemy>()
            {
                new Enemy("들개9", 1, 30, 5, 8, 7, 0),
            };
            floor10List = new List<Enemy>()
            {
                new Enemy("들개10", 1, 30, 5, 8, 7, 0),
            };

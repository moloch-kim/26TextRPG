...
namespace _26TextRPG
{
    ...
    {
        public static List<Quest> AcceptableQuests { get; private set; }
        ...
        static QuestRepository()
        {
            ...
            AcceptableQuests = new List<Quest>() // 퀘스트 리스트
            {
        ...
        {
            return AllSkills.FirstOrDefault(Quest => Quest.Name == Quest);
        }
    }
}